    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0,
                        help_text="Total number of products available",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0,
                        help_text="Number of products remaining after sales",
                        verbose_name="Remaining Count",
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0,
                        help_text="Number of products allocated",
                        verbose_name="Quantity Allocated",
                    ),
                ),
                (
                    "allocated_to",
                    models.CharField(
                        help_text="Person or entity to whom the products are allocated",
                        max_length=255,
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="invmanage.product",
                    ),
                ),
            ],
            options={
                "verbose_name": "Product Allocation",
                "verbose_name_plural": "Product Allocations",
            },
        ),
        migrations.CreateModel(
            name="ProductImage",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.RESTRICT,
                        to="invmanage.productspecification",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.RESTRICT, to="invmanage.producttype"
            ),
        ),
    ]
